 ...
 */
import { toOfficialConfig, type McpServerInput } from "./model.js";
import { importFromHarness } from "./harness-resolve.js";

/** 一条待挂载的工作区服务器（凭证已解析成明文）。 */
 ...
 */
export async function loadMcpClientComponent(ctx: any): Promise<any | undefined> {
 ...
 */
export async function mountWorkspaceServers(
  agentCtx: any,
  servers: MountableServer[],
  component: any
