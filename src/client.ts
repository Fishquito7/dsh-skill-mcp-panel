...
const cssGroupDelete = ".SKV_groupItemWrap{position:relative;display:inline-flex;align-items:center}.SKV_groupDelete{display:none;width:16px;height:16px;align-items:center;justify-content:center;color:var(--dsw-alias-label-tertiary);font:inherit;font-size:12px;line-height:14px;cursor:pointer;background:0 0;border:none;border-radius:999px;padding:0;margin-left:2px;flex:none}.SKV_groupItemWrap:hover .SKV_groupDelete{display:inline-flex}.SKV_groupDelete:hover{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 10%, transparent)}.SKV_groupDelete[data-confirm=true]{display:inline-flex;width:auto;height:18px;padding:0 7px;color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 10%, transparent)}";
const css = cssChrome + cssCards + cssAdd + cssScope + cssMigrate + cssGroupDelete + cssIcon + cssIconMcp;
...
// 拖放：支持拖入 .md / .zip 文件与技能文件夹（自动识别结构）。
			...
			return (0, react_jsx_runtime.jsx)("div", {
				...
				updateBanner !== null ? (0, react_jsx_runtime.jsxs)("div", {
					...
					const group = key === "all" ? undefined : groupByKey.get(key);
					return [(0, react_jsx_runtime.jsx)("span", {
						className: c.groupSep,
						"aria-hidden": "true",
						children: "|"
					}, "sep-" + key), (0, react_jsx_runtime.jsxs)("span", {
						className: c.groupItemWrap,
						children: [(0, react_jsx_runtime.jsx)("button", {
							type: "button",
						...
						}, key), group !== undefined ? (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							className: c.groupDelete,
							"data-confirm": groupDeleteConfirm === group.id ? "true" : void 0,
							disabled: groupDeleteBusy,
							"aria-label": groupDeleteConfirm === group.id ? t("confirmDelete") : t("deleteLabel"),
							title: groupDeleteConfirm === group.id ? t("confirmDelete") : t("deleteLabel"),
							onClick: (event) => {
								event.stopPropagation();
								applyDeleteGroupTag(group);
							},
							children: groupDeleteConfirm === group.id ? t("confirmDelete") : "×"
						}) : null]
					}, "wrap-" + key)];
				}).concat([(0, react_jsx_runtime.jsx)("span", {
							className: c.groupSep,
							"aria-hidden": "true",
							children: "|"
						}, "sep-end")])
