window.__ModuleLoader__.load({
    ...
    factory: (require) => {
        ...
        const zh = {
            ...
            checkUpdateHint: "）。可在终端运行 dsh-panel skill update 更新"
        };
        const en = {
            nav: "Skills",
            ...
            checkUpdateHint: "). Run dsh-panel skill update in a terminal to install it"
        };
        // ── 远程贡献 ─────────────────────────────────────────────────────────
        ...
        const mcpZh = {
            ...
            fieldEnv: "env（每行 KEY=VALUE；已配置的 key 留空保持不变）",
            fieldCwd: "cwd（留空使用默认）",
            fieldUrl: "url",
            fieldHeaders: "headers（每行 KEY=VALUE；已配置的 key 留空保持不变）",
            fieldTimeout: "toolCallTimeoutMs",
            fieldFailOnStartup: "启动失败即报错",
            fieldReconnect: "自动重连",
        ...
        function McpFormDialog({ t, initial, onSave, onCancel, busy, error }) {
            ...
            const fields = [
                field(t("fieldServerName"), textInput(form.serverName, (value) => set({ serverName: value })), false),
            ...
            if (form.transport === "stdio") {
                fields.push(field(t("fieldCommand"), textInput(form.command, (value) => set({ command: value }), "npx"), true));
                fields.push(field(t("fieldArgs"), textArea(form.argsText, (value) => set({ argsText: value }), "-y\\n@scope/server"), true));
                fields.push(field(t("fieldEnv"), secretEditor(envKeys, deletedEnv, setDeletedEnv, form.envText, (value) => set({ envText: value }), "GITHUB_TOKEN=..."), true));
                fields.push(field(t("fieldCwd"), textInput(form.cwd, (value) => set({ cwd: value }), "C:\\work"), false));
            }
            else {
                fields.push(field(t("fieldUrl"), textInput(form.url, (value) => set({ url: value }), "http://localhost:3000/mcp"), true));
                fields.push(field(t("fieldHeaders"), secretEditor(headerKeys, deletedHeaders, setDeletedHeaders, form.headersText, (value) => set({ headersText: value }), "Authorization=Bearer ..."), true));
            }
        ...
        function McpSection({ t, listMcp, saveMcp, removeMcp, setEnabledMcp, testMcp, reloadMcp }) {
            ...
            const applyToggle = async (server) => {
                try {
                    const next = await setEnabledMcp(server.serverName, !server.enabled);
            ...
            const serverCard = (server, isExternal) => {
                ...
                return (0, react_jsx_runtime.jsxs)("div", {
                    ...
                    children: [(0, react_jsx_runtime.jsxs)("div", {
                            ...
                            children: [(0, react_jsx_runtime.jsx)("span", {
                                    className: m.dot,
                                    "data-on": dotOn ? "true" : "false",
                                    "data-err": dotErr ? "true" : "false"
                                }), t !== null ? t(state) : "", (0, react_jsx_runtime.jsx)("span", { children: t !== null ? t("toolCount").replace("{count}", String(server.toolCount ?? 0)) : "" })]
                            ...
                            children: [(0, react_jsx_runtime.jsxs)("label", {
                                    ...
                                    children: [(0, react_jsx_runtime.jsx)("button", {
                                        ...
                                        }), (0, react_jsx_runtime.jsx)("span", { className: c.switchText, children: t !== null ? (server.enabled ? t("disable") : t("enable")) : "" })]
                                }), (0, react_jsx_runtime.jsx)("button", {
                                    type: "button",
                                    ...
                                    children: t !== null ? t("editTitle") : ""
                                }), (0, react_jsx_runtime.jsx)("span", { className: m.spacer }), confirming === server.serverName ? (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, {
                                    children: [
                                        (0, react_jsx_runtime.jsx)("button", {
                                            type: "button",
                                            className: m.actionBtn,
            ...
            return (0, react_jsx_runtime.jsxs)("div", {
                ...
                children: [(0, react_jsx_runtime.jsxs)("div", {
                    ...
                    }), (0, react_jsx_runtime.jsx)("p", { className: m.sub, children: t !== null ? t("subtitle") : "" }), patch?.ok === false ? (0, react_jsx_runtime.jsxs)("div", {
                        className: c.notice,
                        "data-kind": "error",
