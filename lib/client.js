    ...
    factory: (require) => {
        ...
        function SkillsSection(props) {
            ...
            const groupCount = (group) => {
                const rows = membersOfGroup(group);
                return {
                    total: rows.length,
            ...
            const applyGroupToggle = (group) => {
                const editable = membersOfGroup(group).filter(isEditableSkill);
                    ...
                    children: [
                        ...
                        scopeGroupRows.length > 0 ? (0, react_jsx_runtime.jsxs)("div", {
                            ...
                            children: [(0, react_jsx_runtime.jsx)("button", {
                                    ...
                                    // 组内没有可开关的技能：禁用并说明原因，避免点击无反应。
                                    const blocked = counts.editable === 0;
                                    return (0, react_jsx_runtime.jsxs)("span", {
                                        ...
                                        children: [(0, react_jsx_runtime.jsx)("button", {
                                                ...
                                                "aria-label": (allOn ? t("groupBulkOff") : t("groupBulkOn")) + "：" + group.name,
                                                title: blocked ? t("groupBulkBlocked") : (allOn ? t("groupBulkOff") : t("groupBulkOn")) + " · " + counts.on + "/" + counts.total,
                                                disabled: blocked || bulkGroup === group.id,
                                                onClick: () => {
                                                    applyGroupToggle(group);
                                                },
